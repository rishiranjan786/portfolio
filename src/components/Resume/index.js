      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold  text-white ml-40">
              Work Experience
            </h3>
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
              Completed on 2018 to 2020
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
              Experienced computer trainer under PMKVY for 2 years. Specialized in empowering individuals with digital literacy and job-ready skills. Contributed to the Pradhan Mantri Kaushal Vikas Yojana initiative, facilitating workforce development and employment opportunities.
            </p>
            {/* <a
          ...
          <li class="mb-10" data-aos="zoom-out" data-aos-delay="700">
            ...
            <p class="text-base font-normal text-gray-400">
              Team Leader of Final Year College Project, Captain of College Cricket Team, Volunteered at[Child Care
              Foundation] to support underprivileged children's education and development.
            </p>
            {/* <a
              href="https://www.freecodecamp.org/certification/Rishi_Ranjan/back-end-development-and-apis"
              target="_blank"
              rel="noreferrer"
          ...
          <li data-aos="zoom-in" data-aos-offset={"-15"} data-aos-delay="1300">
            ...
            <p class="text-base font-normal text-gray-400">
              NIPAM, the National Intellectual Property Awareness Mission, aims to promote understanding and utilization of intellectual property rights across India. Through education and outreach programs, it seeks to foster innovation, protect creativity, and enhance economic growth.
            </p>
            {/* <a
              target="_blank"
              rel="noreferrer"
              href="https://www.freecodecamp.org/certification/Rishi_Ranjan/front-end-development-libraries"
              class="inline-flex items-center px-4 py-2 mt-5 text-sm font-medium border rounded-lg focus:z-10 focus:ring-4 focus:outline-none focus:text-blue-700 bg-gray-800 text-gray-400 border-gray-600 hover:text-white hover:bg-gray-700 focus:ring-gray-700"
            >
              <svg
                class="w-4 h-4 mr-2"
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            ...
            <BarGraph name={"NodeJs"} percent={65} />
            <BarGraph name={"MongoDb"} percent={75} />
            <BarGraph name={"SQL"} percent={75} />
            <BarGraph name={"HTML/CSS"} percent={90} />
            {/* <BarGraph name={""} percent={40} /> */}
          </div>
