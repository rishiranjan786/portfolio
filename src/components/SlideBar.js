    ...
    <div className="flex-none hidden lg:block  bg-black h-screen min-w-[25%] fixed ">
        ...
        <div data-aos="slide-down">
          <NavLink to={"/activity"}>
            <img
              ...
              className="rounded-[50%] border-solid cursor-pointer  border-[8px] border-stone-600 min-h-fit mx-auto  max-w-[190px]"
            />
      ...
      >
        <div
          title="Github"
          onClick={() =>
            window.open("https://github.com/rishiranjan786", "_blank")
          }
        >
        ...
        <div
          ...
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/rishi-ranjan-992991221/",
              "_blank"
            )
          }
        >
        ...
        <div
          title="Facebook"
          onClick={() =>
            window.open("https://www.facebook.com/profile.php?id=100090100225550&mibextid=ZbWKwL", "_blank")
          }
        >
